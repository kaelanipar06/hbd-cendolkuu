...
btnCard.addEventListener("click", () => {
  ...
  lanjut1.addEventListener("click", () => {
    ...
    <div class="textArea">
    <p>Mudah-mudahan semakin :</p>
    <ul>
          <li>Baik,</li> 
          <li>Sholehah,</li>
          <li>Sayang Papa Mama,</li>
          <li>Pinter,</li>
          <li>Sukses,</li>
          <li>Lancar rejekinya,</li>
          <li>Dan sayang sama Kael juga😁.</li>
          </ul>
    ...
    lanjut2.addEventListener('click',()=>{
      ...
      lanjut3.addEventListener('click',()=>{
        ...
        <p class="al-center">Ayang dikurangin overthinkingnya yak, terus ayang jangan marah-marah mulu juga, kasian akunya wkwk🤗😋😘</p>
        </div>
        <div class="btnArea">
        ...
        lanjut4.addEventListener('click',()=>{
          ...
          <div class="textArea">
          <p class="al-center gede">💖</p>
          <p class="al-center">Cintaku kepadamu melebihi cintaku kepada semesta pokoknya 🤣🤣🤣</p>
          </div>
          <div class="btnArea">
        ...
        lanjut5.addEventListener('click',()=>{
          ...
          <p class="al-center">Udah si... gitu aja, pokoknya kael itu sayaannggggg baangeeeeeeet sama cendol😋</p>
          </div>
          <div class="btnArea">
